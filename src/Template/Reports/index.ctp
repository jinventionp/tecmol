    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('reportfolder_id') ?></th>
                <th scope="col"><?= $this->Paginator->sort('name') ?></th>
                <th scope="col"><?= $this->Paginator->sort('primarymodule') ?></th>
                <th scope="col"><?= $this->Paginator->sort('secondarymodules') ?></th>
                <th scope="col"><?= $this->Paginator->sort('selectcolumns') ?></th>
