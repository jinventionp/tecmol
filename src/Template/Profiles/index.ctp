    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('review_1') ?></th>
                <th scope="col"><?= $this->Paginator->sort('review_2') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($profile->root) ?></td>
                <td><?= h($profile->delete) ?></td>
                <td><?= h($profile->created) ?></td>
                <td><?= h($profile->modified) ?></td>
                <td><?= h($profile->review_1) ?></td>
                <td><?= h($profile->review_2) ?></td>
                <td><?= h($profile->edit) ?></td>
                <td class="actions">
