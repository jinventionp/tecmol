...
<div class="requests view large-9 medium-8 columns content">
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($request->samples as $samples): ?>
            <tr>
                <td><?= h($samples->id) ?></td>
