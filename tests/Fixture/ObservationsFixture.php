...
class ObservationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_observations_samples1_idx' => ['type' => 'index', 'columns' => ['sample_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'observations_ibfk_1' => ['type' => 'foreign', 'columns' => ['sample_id'], 'references' => ['samples', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'delete' => 1,
                'created' => '2019-09-03 17:02:59',
                'modified' => '2019-09-03 17:02:59'
            ],
        ];
        parent::init();
    }
