...
class OperatorsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'operator' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-09-03 17:03:27',
                'modified' => '2019-09-03 17:03:27'
            ],
        ];
        parent::init();
    }
